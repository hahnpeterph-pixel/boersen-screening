...
_Erstellt 2026-09-01 07:16 UTC. 218 Werte, Fenster 90 Kalendertage. EUR/USD 1.1606._

Reiner Datenabzug. Knock-out-Schwellen, Positionsgroessen und Regelpruefung werden bewusst NICHT hier gerechnet - sie aendern sich staendig und wuerden diese Datei pflegebeduerftig machen.

Vollstaendige Daten: `docs/marktdaten.csv`

> **Standwarnung: 169 von 205 Aktien haengen zurueck.** Neuester Handelstag 2026-09-01. Fuer die folgenden Werte gelten Kurs, ATR, RSI und Tiefs NICHT fuer diesen Tag. Die Spalte `stand_zurueck` in der CSV markiert sie ebenfalls.
>
> | Wert | letzte Kerze |
> |---|---|
> | MRK.DE | 2026-08-28 |
...
| ENR.DE (ENR.DE) | 139.56 | - | - | ja | 34.32 |
| SHL.DE (SHL.DE) | 39.24 | - | - | ja | 56.33 |
| VNA.DE (VNA.DE) | 19.295 | - | - | ja | 31.7 |

...
_Erstellt 2026-09-02 21:39 UTC. Fenster: letzte 90 Kalendertage. Tiefs nach der Umkehr-Regel (tiefs_regel.py): ein Tief zaehlt, sobald eine spaetere Kerze das Hoch der Tiefkerze ueberschreitet. Solange es abwaerts geht, gilt das tiefste Tief der Strecke. Gerechnet wird auf abgeschlossenen Tageskerzen._
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| NVIDIA (NVDA) _Kandidat_ | 224,41 | 209,00 | 7,4 % | 215,10 | 7,17 | 56,7 | 66,9 (Tief 1, n=122) | 200,75 | **150,00 EUR** | hoeheres Hoch — CHART PRUEFEN | + |
| Applied Materials (AMAT) _Kandidat_ | 438,46 | 465,00 | -5,7 % | 433,57 | 22,39 | 33,7 | 38,6 (Tief 3, n=17) | 388,79 | **150,00 EUR** | Marke erreicht — CHART PRUEFEN | + |
...
| Oracle (ORCL) | 02.09.2026 | 139,72 | 21,8 Mio. | 0,97x | 19,3 % |
